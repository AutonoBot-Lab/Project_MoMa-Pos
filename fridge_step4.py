...
# with open('/home/sc-5/Desktop/shao/step3/potential_energy_data.csv', 'w', newline='') as file:
#     writer = csv.writer(file)
#     writer.writerow(['X Coordinate', 'Y Coordinate', 'Potential Energy'])
#     for i in range(len(points_list)):
#         writer.writerow([x_coords[i], y_coords[i], potential_energies[i]])
